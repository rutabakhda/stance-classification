...
import de.aitools.ie.uima.feature.length.SentenceLength;
 ...
 *
 */
public class SentenceLengthTokenPosNGrams implements IFeatureType {
	...
	private IFeatureType sentenceLength;
	...
	public void initializeFeatureDetermination(Properties configurationProps) {
		...
		this.sentenceLength = new SentenceLength();
		...
		this.sentenceLength.initializeFeatureDetermination(configurationProps);
	}
	...
	public void updateCandidateFeatures(JCas jcas, int start, int end) {
		...
		this.sentenceLength.updateCandidateFeatures(jcas, start, end);
	}
	...
	public List<String> determineFeatures(Properties configurationProps, Properties normalizationProps) {
		...
		featureNames.addAll(this.sentenceLength.determineFeatures(configurationProps, normalizationProps));
		return featureNames;
	}
	...
	public void initializeFeatureComputation(List<String> allFeatureNames, Properties configurationProps, Properties normalizationProps) {
		...
		this.sentenceLength.initializeFeatureComputation(allFeatureNames, configurationProps, normalizationProps);
	}
	...
	public List<Double> computeNormalizedFeatureValues(JCas jcas, int start, int end) {
		...
		featureValues.addAll(this.sentenceLength.computeNormalizedFeatureValues(jcas, start, end));
