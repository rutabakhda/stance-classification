...
public class AnnotatorTaskPage extends AnnotatorPage {
  ...
  public AnnotatorTaskPage(final String projectName,
      final List<String> cssIncludes, final List<String> jsIncludes)
  throws NullPointerException {
    super(projectName, cssIncludes,
        Page.addToList(jsIncludes, "/js/wat-task.js"));
  }
  ...
  protected void printInFileScripts(final PrintWriter output,
    ...
    for (final Component component : state.getTask()) {
      output.append("  setValueFunctions[\"").append(component.getName())
        .append("\"] = ").append(component.getJsValueFunctionName())
        .append(";\n");
    }
    ...
    for (final Component component : state.getTask()) {
      for (final String jsInitFunction : component.getJsInitFunctionNames()) {
        output.append("  ").append(jsInitFunction)
    ...
    for (final Entry<String, ComponentState> componentEntry : state) {
      ...
      for (final Entry<String, String> entry : componentState) {
        final String value = entry.getValue()
            .replaceAll("\n", "\\\\n").replaceAll("\"", "\\\\\"");
        output.append("  setValue(\"").append(componentName)
    ...
    // Set complete (or not)
    output.append("  setComplete(").append(String.valueOf(state.isComplete()))
      .append(");\n");
...
output.append("<div class=\"panel\"><div class=\"panel-heading\">\n");
    output.append(" INSTRCUTIONS.\n")
	.append(" You can assign 2 lables.\n")
	.append(" 1. Conclusion\n")
	.append(" 2. Non conclusion\n");
    output.append("</div></div><br />\n");
  ...
  private void printComponent(final PrintWriter output,
      final Component component)
  throws IOException {
    output.append("<div class=\"panel panel-primary\">\n");
    output.append("  <div id=\"").append(component.getName()).append("-toggle\"")
      .append(" class=\"panel-heading panel-collapse-toggle collapsed\"")
      .append(" data-toggle=\"collapse\"").append(" data-target=\"#")
      .append(component.getName()).append("-body\">\n");
    ...
    if (!component.isRequired()) {
      ...
      output.append("<span id=\"").append(component.getName())
        .append("-state\"></span>");
    }
    output.append(")</div>\n");
    output.append("  <div id=\"").append(component.getName()).append("-body\"")
  ...
  private void printTaskCompleteBox(final PrintWriter output) {
    output.append("<div class=\"is-complete-box panel panel-success\"")
      .append(" style=\"display:none;\">")
      .append("<div class=\"panel-heading\"><strong>\n");
    output.append("  This task is completed.")
      .append(" You may do further changes if you want.\n");
